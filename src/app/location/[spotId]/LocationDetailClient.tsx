// src/app/location/[spotId]/LocationDetailClient.tsx
"use client";
...
// Styled components (unchanged, included for reference)
...
export default function LocationDetailClient({ initialSpot, spotId }: LocationDetailClientProps) {
